    ...
    public static void main(String[] args) {
    	...
    	try {
            ...
            connection = DriverManager.getConnection(
                                                     "jdbc:postgresql://cmps180-db.lt.ucsc.edu/kluon7",
                                                     "kluon7",
                                                     "cartesian60select");
            ...
            //Test for getLeaseTenantsWithApartmentsInManyHouses
            List<Integer> result_ssn = app.getLeaseTenantsWithApartmentsInManyHouses(4);
            for(Integer ssn : result_ssn){
            ...
            */
            ...
            //Test for raiseSalary
            app.raiseSalary("John Smith", 10000);
            System.out.println("Raised John Smith's salary by 10000.");
            

            //Test for movePersonToApartment
            //Test 1 for success
            int move_to = app.movePersonToApartment(631952071, "401 Heller Drive", 1);
            System.out.println(move_to);
            //Test 2 for fail
            int move_to2 = app.movePersonToApartment(563960185, "401 Heller Drive", 10);
            System.out.println(move_to2);
            /*******************
            * Your code ends here */
